...
INSERT INTO `postcard`.`PROPERTIES` (`id`,`name`,`value`) VALUES (38,'createImageQuery','insert into image(imageType) values (?)');
INSERT INTO `postcard`.`PROPERTIES` (`id`,`name`,`value`) VALUES (39,'findOnePostcardQuery','SELECT * FROM image WHERE imageId = ?');
INSERT INTO `postcard`.`PROPERTIES` (`id`,`name`,`value`) VALUES (40,'findallImageQuery','select * from image');
INSERT INTO `postcard`.`PROPERTIES` (`id`,`name`,`value`) VALUES (41,'deletePostcardQuery','delete from image where imageId = ?');
